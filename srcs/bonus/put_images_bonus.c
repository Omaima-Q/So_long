...
/*   Updated: 2024/11/15 19:41:33 by oqaroot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	destroy_images(t_game *game)
{
	...
	destroy_if_not_null(game, game->sprite.right_win);
	destroy_if_not_null(game, game->sprite.down_win);
	destroy_if_not_null(game, game->sprite.up_win);
	destroy_if_not_null(game, game->sprite.left_win);
